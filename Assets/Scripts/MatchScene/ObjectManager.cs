...
namespace Simuro5v5
{
    ...
    public static class ObjectManager
    {
        ...
        public static MatchInfo OutputMatchInfo { get; set; }
        ...
        public static void RefreshToScene(MatchInfo matchInfo)
        {
            SetBallPlacement(matchInfo.CurrentBall);
            SetBluePlacement(matchInfo.BlueRobot);
            SetYellowPlacement(matchInfo.YellowRobot);
        }

        public static void RefreshToScene()
        {
            RefreshToScene(OutputMatchInfo);
        }
